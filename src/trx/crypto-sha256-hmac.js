        ...
        var d = (global.Crypto = {}),
            k = (d.util = {
                ...
                bytesToWords: function (b) {
                    for (var a = [], c = 0, e = 0; c < b.length; c++, e += 8) a[e >>> 5] |= (b[c] & 255) << (24 - (e % 32));
                    return a;
                },
                ...
                bytesToBase64: function (b) {
                    for (var a = [], c = 0; c < b.length; c += 3)
                        for (var e = (b[c] << 16) | (b[c + 1] << 8) | b[c + 2], p = 0; p < 4; p++)
                            c * 8 + p * 6 <= b.length * 8 ? a.push("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt((e >>> (6 * (3 - p))) & 63)) : a.push("=");
                    return a.join("");
                },
                base64ToBytes: function (b) {
                    for (var b = b.replace(/[^A-Z0-9+\/]/gi, ""), a = [], c = 0, e = 0; c < b.length; e = ++c % 4)
                        e != 0 &&
                            a.push(
                                (("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".indexOf(b.charAt(c - 1)) & (Math.pow(2, -2 * e + 8) - 1)) << (e * 2)) |
                                    ("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".indexOf(b.charAt(c)) >>> (6 - e * 2))
                            );
                    return a;
                },
            }),
    ...
    e._sha256 = function (a) {
        ...
        for (t = 0; t < e.length; t += 16) {
            ...
            for (h = 0; h < 64; h++) {
                h < 16
                    ? (d[h] = e[h + t])
                    : ((l = d[h - 15]), (j = d[h - 2]), (d[h] = (((l << 25) | (l >>> 7)) ^ ((l << 14) | (l >>> 18)) ^ (l >>> 3)) + (d[h - 7] >>> 0) + (((j << 15) | (j >>> 17)) ^ ((j << 13) | (j >>> 19)) ^ (j >>> 10)) + (d[h - 16] >>> 0)));
                j = (f & g) ^ (f & m) ^ (g & m);
                var u = ((f << 30) | (f >>> 2)) ^ ((f << 19) | (f >>> 13)) ^ ((f << 10) | (f >>> 22));
                l = (s >>> 0) + (((i << 26) | (i >>> 6)) ^ ((i << 21) | (i >>> 11)) ^ ((i << 7) | (i >>> 25))) + ((i & n) ^ (~i & o)) + c[h] + (d[h] >>> 0);
                j = u + j;
                s = o;
                o = n;
                n = i;
